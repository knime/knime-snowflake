 ...
 */
public final class ApproxTopKEstimateDBAggregationFunction extends AbstractNumberDBAggregationFunction {

    private static final String LABEL = "APPROX_TOP_K_ESTIMATE";
    ...
    public static final class Factory implements DBAggregationFunctionFactory {
        ...
        public DBAggregationFunction createInstance() {
            return new ApproxTopKEstimateDBAggregationFunction();
        }
    }
     ...
     * Constructor.
     */
    private ApproxTopKEstimateDBAggregationFunction() {
    ...
    public String getDescription() {
        return "Returns the approximate most frequent values and their estimated frequency for the given "
            + "Space-Saving state.";
    }
