 ...
 */
public class AdditionalNumberParameterSettingsPanel extends JPanel {
    ...
    /**
     * Constructor.
     * @param settings the {@link AdditionalNumberParameterSettings}
     * @param label the label for this Panel
     */
    public AdditionalNumberParameterSettingsPanel(final AdditionalNumberParameterSettings settings,
        final String label) {
        ...
        rootPanel.add(m_numberComponent.getComponentPanel(), c);
        add(rootPanel);
    }

    /**
     * Read value(s) of this dialog component from the configuration object. This method will be called by the dialog
     * pane only.
     *
     ...
     *             are valid), e.g. if the given spec lacks some important columns or column types.
     */
