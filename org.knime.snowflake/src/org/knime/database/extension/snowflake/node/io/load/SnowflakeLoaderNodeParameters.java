...
class SnowflakeLoaderNodeParameters extends DBLoaderParametersBase {
    ...
    @Persist(configKey = "fileFormatSelection")
    @ValueReference(FileFormatRef.class)
    SnowflakeLoaderFileFormat m_fileFormat = SnowflakeLoaderFileFormat.CSV;
    ...
    @Modification(RestrictCharacterEncodingModification.class)
    CSVFormatSettings m_csvFormat = new CSVFormatSettings();

    static final class RestrictCharacterEncodingModification extends CSVFormatSettingsModifier {
    ...
    // private static fields copied from {@link SnowflakeLoaderFileFormat}
    ...
    static final class CompressionChoicesProvider implements StringChoicesProvider {
        ...
        public List<String> choices(final NodeParametersInput context) {
            ...
            if (format == SnowflakeLoaderFileFormat.CSV) {
                return List.of(NONE_COMPRESSION, GZIP_COMPRESSION);
            }
            // Parquet
            return List.of(SNAPPY_COMPRESSION, GZIP_COMPRESSION, NONE_COMPRESSION);
        }
