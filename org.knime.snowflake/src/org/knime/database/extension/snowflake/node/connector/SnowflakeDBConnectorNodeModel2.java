...
public class SnowflakeDBConnectorNodeModel2 extends SpecificDBConnectorNodeModel<SnowflakeDBConnectorNodeSettings2> {
    ...
    protected DBConnectionController createConnectionController(final List<PortObject> inObjects,
        ...
        if (hasInputPort) {
            ...
            final AuthenticationSettings authentication = sessionSettings.m_authentication;
            ...
            return new UserDBConnectionController( //
                ...
                AuthenticationType.valueOf(sessionSettings.m_authentication.getType().name()), //
    ...
    protected DBConnectionController createConnectionController(final SnowflakeDBConnectorNodeSettings2 modelSettings)
        throws InvalidSettingsException {
        throw new UnsupportedOperationException("This method is not supported in SnowflakeDBConnectorNodeModel2. "
            + "Use the other createConnectionController methods instead.");
    }
}
